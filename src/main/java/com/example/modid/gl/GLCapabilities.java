...
public class GLCapabilities {
    ...
    private static void parseVersion(String version) {
        try {
            ...
            if (matcher.find()) {
                detectedMajor = Integer.parseInt(matcher.group(1));
    ...
    private static void queryLimits() {
        try {
            ...
            if (GL20) {
                ...
                // Fallback for ancient GL (shouldn't happen, but safe)
